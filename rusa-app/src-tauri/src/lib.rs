...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::settlement_commands::get_settler_task,
            commands::settlement_commands::assign_settler_task,
            commands::settlement_commands::update_task_progress,
            commands::settlement_commands::append_settler_task_activity_log,
            commands::settlement_commands::request_settler_task_conclusion,
            commands::settlement_commands::review_settler_task_conclusion,
            ...
            commands::aerospace_commands::get_aerospace_task,
            commands::aerospace_commands::update_aerospace_task_status,
            commands::aerospace_commands::append_aerospace_task_activity_log,
