<script lang="ts">
  ...
  const navItems: NavItem[] = [
    ...
    { path: '/mathematics', label: 'Mathematics', icon: '∑', roles: ['mathematician', 'the_artificer', 'the_taskmaster'] },
    { path: '/theoretical', label: 'Theoretical Sciences', icon: '⟁', roles: ['the_artificer', 'the_taskmaster'] },
